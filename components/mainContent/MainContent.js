  ...
  return (
    <div className="relative overflow-hidden mb-8">
      <section
        ...
        className="relative max-w-7xl mx-auto pt-32 px-4 flex flex-col items-center text-center sm:px-6 lg:px-8 sm:border-b mb-6"
      >
        <div className="max-w-2xl mx-auto lg:max-w-none">
          <h2
            id="sale-heading"
            className="text-4xl font-extrabold tracking-tight text-darkgreen sm:text-5xl "
          >
            INSTALL A STUNNING MOSS FEATURE WALL
          </h2>
          <p className="mt-4 max-w-xl mx-auto text-xl text-brown">
            ADD A BREATH OF LIFE TO YOUR SPACE IN FORT COLLINS, CO WITH OUR
            CUSTOM MOSS WALLS
          </p>
          <p className="mt-6 w-full  border border-transparent rounded-md py-3 px-8 font-medium text-copy  sm:w-auto">
